 ...
 * @author DAO
 */
public class Fruit_Shop_System extends Menu<String> {
    static String mc[] = {"Create Fruit", "View Order", "Shopping (for buyer)", "Exit"};
    Library Validation;
    ArrayList<Fruit> lf;
    Map<String, ArrayList<Order>> ht;
    public Fruit_Shop_System(){
